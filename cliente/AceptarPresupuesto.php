<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        $Consulta = "UPDATE presupuesto_noregistrado SET aceptoCliente = '$aceptoCliente' WHERE
                    idPresupuestoNoRegistrado ='$idPresupuestoNoRegistrado'";
       // echo 'entro';
            if(mysqli_query($Conexion,$Consulta)){
                $sql = "INSERT INTO contrato_noregistrado (Fecha_Inicio_NoRegistrado, presupuesto_noR) VALUES (NOW(),
