<?php
  ...
  FROM
      oficio_kerkly
  INNER JOIN presupuesto_noregistrado ON oficio_kerkly.idoficio_trabajador = presupuesto_noregistrado.idOficio
  ...
  WHERE
   ...
   WHERE
      oficios.nombreO = '$oficio' AND presupuesto_noregistrado.kerkly_aceptado = 0 AND presupuesto_noregistrado.PagoTotal = 0.0;";
