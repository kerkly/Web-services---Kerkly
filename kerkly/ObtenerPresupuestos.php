...
if($_SERVER['REQUEST_METHOD']=='GET'){
    ...
    inner JOIN direccion on cliente.Direccion_idDireccion = direccion.idDireccion WHERE kerkly.Telefono = '$Telefono'
    and presupuesto.pago_total is NULL || presupuesto.pago_total = 0.0;";
